...
global.defaultjs.ical = global.defaultjs.ical || {
	VERSION : "1.0.1",
	Parser: _src__WEBPACK_IMPORTED_MODULE_0__.Parser,
	ICalendar: _src__WEBPACK_IMPORTED_MODULE_0__.ICalendar
};
...
if(typeof global.fetch === "function" 
	...
	global.Response.prototype.ical = function(aConfig){
		return this.text()
		.then(function(aText){
			return _src__WEBPACK_IMPORTED_MODULE_0__.ICalendar.parse(aText, aConfig);
		});
	}
};
